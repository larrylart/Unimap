...
// Output:	nothing
/////////////////////////////////////////////////////////////////////
CSkyCatalogStarsNomad::CSkyCatalogStarsNomad( CSkyCatalogStars* pCatalogStars, CUnimapWorker* pWorker )
{
	...
	m_pCatalogStars->m_strName = wxT("NOMAD");
	m_pCatalogStars->m_strLabel = wxT("NOMAD");
	m_pCatalogStars->m_nCatalogLoaded = CATALOG_ID_NOMAD;
	m_pCatalogStars->m_nObjectType = CAT_OBJECT_TYPE_NOMAD;
...
// Output:	nothing
/////////////////////////////////////////////////////////////////////
CSkyCatalogStarsNomad::~CSkyCatalogStarsNomad( )
{
...
// Output:	nothing
/////////////////////////////////////////////////////////////////////
unsigned long CSkyCatalogStarsNomad::Load( int nLoadType, int nLoadSource, int nLoadLimit,
										...
										double nWidth, double nHeight )
{
	...
	if( nLoadSource == CATALOG_QUERY_SOURCE_VIZIER )
	{
		...
		nCount = oRemote.GetStarsFromVizier( CATALOG_ID_NOMAD, bRegion, nRa, nDec, nWidth, nHeight );
...
// Output:	nothing
/////////////////////////////////////////////////////////////////////
unsigned long CSkyCatalogStarsNomad::LoadBinary( const wxString& strFile, int nLoadLimit,
								int bRegion, double nRa, double nDec,
										double nWidth, double nHeight )
{
	FILE* pFile = NULL;
...
*/
	...
	if( bRegion )
	{
		strLog.Printf( wxT("INFO :: loading Nomad area orig(%.2f,%.2f) size(%.2f,%.2f)..."),
	...
	{
		m_pUnimapWorker->Log( wxT("INFO :: loading the entire Nomad catalog ...") );
	}
...
*/
	...
	if( m_pUnimapWorker )
	{
		strLog.Printf( wxT("INFO :: loaded %d stars from NOMAD"), nStar );
		m_pUnimapWorker->Log( strLog );
	}
...
// Output:	nothing
/////////////////////////////////////////////////////////////////////
int CSkyCatalogStarsNomad::ExportBinary( const wxString& strFile )
{
	FILE* pFile = NULL;
	unsigned long i = 0;
