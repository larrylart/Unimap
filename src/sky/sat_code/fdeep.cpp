...
void Deep_dpinit( const tle_t *tle, deep_arg_t *deep_arg)
{
   ...
   const double days_since_1900 = tle->epoch - 2415020.;
           ...
           /* orbit = 23.444100 degrees... possibly B1950 obliquity?   */
...
/* if( days_since_1900 != deep_arg->preep)   */
      {
      const double xnodce = 4.5236020 - 9.2422029E-4 * days_since_1900;
   ...
   if( deep_arg->xnq >= 0.00826 && deep_arg->xnq <= 0.00924 && tle->eo >= .5)
      {           /* start of 12-hour orbit, e >.5 section */
                  ...
                  /* harmonics of the gravitational potential:           */
      ...
      const double f543 = 29.53125*deep_arg->sinio*(-2-8*deep_arg->cosio+
                 ...
                 deep_arg->theta2));
      double g410=0.0, g422=0.0, g520=0.0, g521=0.0, g532=0.0, g533=0.0;
      double g211=0.0, g310=0.0, g322=0.0;
...
{
   double temp=0.0, xni=0.0, xli=0.0;
