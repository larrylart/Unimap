...
// Output:	nothing
/////////////////////////////////////////////////////////////////////
CSkyCatalogStarsGsc::CSkyCatalogStarsGsc( CSkyCatalogStars* pCatalogStars, CUnimapWorker* pWorker )
{
	...
	m_pCatalogStars->m_strName = wxT("GSC");
	m_pCatalogStars->m_strLabel = wxT("GSC");
	m_pCatalogStars->m_nCatalogLoaded = CATALOG_ID_GSC;
	m_pCatalogStars->m_nObjectType = CAT_OBJECT_TYPE_GSC;
...
// Output:	nothing
/////////////////////////////////////////////////////////////////////
CSkyCatalogStarsGsc::~CSkyCatalogStarsGsc( )
{
...
// Output:	nothing
/////////////////////////////////////////////////////////////////////
unsigned long CSkyCatalogStarsGsc::Load( int nLoadType, int nLoadLimit,
										int bRegion, double nRa, double nDec,
										double nWidth, double nHeight )
{
	CVizier oRemote( m_pCatalogStars, m_pUnimapWorker );
	unsigned long nCount = oRemote.GetStarsFromVizier( CATALOG_ID_GSC, bRegion, nRa, nDec, nWidth, nHeight );

	return( nCount );
}

// todo: check if used - if so fix!!!
/////////////////////////////////////////////////////////////////////
// Method:	LoadBinary
// Class:	CSkyCatalogStarsGsc
// Purpose:	load the binary version of the catalog to increase speed
...
// Output:	nothing
/////////////////////////////////////////////////////////////////////
unsigned long CSkyCatalogStarsGsc::LoadBinary( const wxString& strFile, int nLoadLimit,
								int bRegion, double nRa, double nDec,
										double nWidth, double nHeight )
{
	FILE* pFile = NULL;
...
*/
	...
	if( bRegion )
	{
		strLog.Printf( wxT("INFO :: loading GSC area orig(%.2f,%.2f) size(%.2f,%.2f)..."),
	...
	{
		m_pUnimapWorker->Log( wxT("INFO :: loading the entire GSC catalog ...") );
	}
...
*/
	...
	if( m_pUnimapWorker )
	{
		strLog.Printf( wxT("INFO :: loaded %d stars from GSC"), nStar );
		m_pUnimapWorker->Log( strLog );
	}
...
// Output:	nothing
/////////////////////////////////////////////////////////////////////
int CSkyCatalogStarsGsc::ExportBinary( const wxString& strFile )
{
	FILE* pFile = NULL;
	unsigned long i = 0;
