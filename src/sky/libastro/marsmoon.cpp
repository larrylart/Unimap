...
// Purpose:	hunt for BDL file in dir[] and use if possible.
// Output:	return 0 if ok, else -1
////////////////////////////////////////////////////////////////////
static int use_bdl(
...
// Purpose:	given mars loc in md[0].ra/dec and size, and location of
//			each moon in md[1..NM-1].x/y in mars radii,find ra/dec 
//			of each moon in md[1..NM-1].ra/dec.
////////////////////////////////////////////////////////////////////
...
// Purpose:	set svis according to whether moon is in sun light
////////////////////////////////////////////////////////////////////
static void moonSVis(
			Obj *sop,		// SUN 
			Obj *mop,		// mars
...
// Purpose: set pshad and sx,sy shadow info
////////////////////////////////////////////////////////////////////
static void moonPShad(
			Obj *sop,             // SUN 
			Obj *mop,             // mars 
			MoonData md[M_NMOONS] )
{
...
// Purpose:	set whether moons are transiting 
////////////////////////////////////////////////////////////////////
static void moonTrans( MoonData md[M_NMOONS] )
{
	int i;
