 ...
 */
int read_bdl( FILE *fp, double jd, double *xp, double *yp, double *zp, char ynot[] )
{
	int npla;
	int nsat;
	int idn[8];
 ...
 */
static int readField( FILE *fp, ScanType f, int width, void *ptr, char ynot[] )
{
	char buf[128];
	char *bp;
 ...
 */
static int readRec( FILE *fp, double *t0, double cmx[], double cfx[], double cmy[],
