...
static void Librations( double RAD, double LAMH, double BH, double OM, double F,
...
static void Moon( double RAD, double T, double T2, double LAM0, double R, double M,
					double *F, double *L1, double *OM, double *LAM, double *B, 
					double *DR, double *LAMH, double *BH )
{
