...
////////////////////////////////////////////////////////////////////
// Method:	plmoon_cir
// Purpose:	find the circumstances for natural satellite object op at np.
// TODO:	distances and helio coords just copied from parent planet.
////////////////////////////////////////////////////////////////////
int plmoon_cir( Now *np, Obj *moonop )
{
	...
	{
	    Sol_CalcObjOrbitPos( np, (Obj*)&plobj[SUN] );
...
// Purpose:	set moonop->s_* fields. np is needed to get local 
//			parallactic angle.
////////////////////////////////////////////////////////////////////
static void setMoon( Now *np, Obj *moonop, Obj *planop, MoonData *mdp )
{
	...
	// TODO -- all fields bellow to do what ?
	moonop->s_gaera = planop->s_gaera;	
	moonop->s_gaedec = planop->s_gaedec;	
	moonop->s_elong = planop->s_elong;	
	moonop->s_size = 0;			
	moonop->s_sdist = planop->s_sdist;	
	moonop->s_edist = planop->s_edist;	
	moonop->s_hlat = planop->s_hlat;	
	moonop->s_hlong = planop->s_hlong;	
	moonop->s_phase = planop->s_phase;	
	...
	// rotation radec to altaz
	if( planop->s_az < PI ) pa = -pa;			
