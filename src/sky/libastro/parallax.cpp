...
/*	- given true ha and dec, tha and tdec, 
	- the geographical latitude, phi, 
	- the height above sea-level (as a fraction of the earths radius, 6378.16km), ht, 
	- and the geocentric distance rho in Earth radii(!), 
	find the apparent
 * ha and dec, aha and adec allowing for parallax.
 * all angles in radians. ehp is the angle subtended at the body by the
 * earth's equator.
 */
void ta_par( double tha, double tdec, double phi, double ht, double *rho, 
