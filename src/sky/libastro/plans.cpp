 ...
 */
static void pluto_ell( double mj,		/* epoch */
						double *ret )	/* ecliptic coordinates {l,b,r} at equinox of date */
{
	...
	double	a = 39.543,			/* semimajor axis, au */
		...
		mjeq = MJ2000,			/* equinox of elements */
	...
	Sol_ReduceElements( mjeq, mj, degrad(inc0), degrad(omeg0), degrad(Om0),
						&inc, &omeg, &Om );
...
////////////////////////////////////////////////////////////////////
// Purpose: geometric heliocentric position of planet, mean ecliptic 
//			of date (not corrected for light-time)
////////////////////////////////////////////////////////////////////
static void planpos( double mj, int obj, double prec, double *ret )
{
 ...
 */
void plans( double mj, PLCode p, double *lpd0, double *psi0, double *rp0,
