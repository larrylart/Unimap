...
// Output:	nothing
/////////////////////////////////////////////////////////////////////
CSkyCatalogXGammaHeao::CSkyCatalogXGammaHeao( CSkyCatalogXGamma* pCatalogXGamma, CUnimapWorker* pWorker ) 
{
...
// Output:	nothing
/////////////////////////////////////////////////////////////////////
CSkyCatalogXGammaHeao::~CSkyCatalogXGammaHeao()
{
									  ...
									  int bRegion, double nCenterRa, double nCenterDec, double nRadius )
{
	...
	} else if( nLoadType == CATALOG_LOAD_REMOTE )
	{
		if( nLoadSource == CATALOG_QUERY_SOURCE_VIZIER )
		{
			...
			nObj = oRemote.GetXGammaFromVizier( CATALOG_ID_HEAO_A1, bRegion, nCenterRa, nCenterDec, nRadius, nRadius );
		}
	}
...
// Method:	LoadBinary
// Class:	CSkyCatalogXGammaHeao
// Purpose:	load the binary version of the HEAO A1 sources catalog
// Input:	if to load region or all
// Output:	nothing
/////////////////////////////////////////////////////////////////////
unsigned long CSkyCatalogXGammaHeao::LoadBinary( const wxString& strFile, double nCenterRa, double nCenterDec, 
										double nRadius, int bRegion )
{
	...
	while( !feof( pFile ) )
	{
		...
		// :: name - 22 chars
		if( !fread( (void*) &(m_pCatalogXGamma->m_vectData[m_pCatalogXGamma->m_nData].cat_name), sizeof(char), 11, pFile ) )
			break;
		// :: catalog number 
...
// Method:	ExportBinary
// Class:	CSkyCatalogXGammaHeao
// Purpose:	export HEAO A1 radio catalog as binary
// Input:	reference vector,size, and file to export to
// Output:	status
/////////////////////////////////////////////////////////////////////
int CSkyCatalogXGammaHeao::ExportBinary( DefCatBasicXGamma* vectCatalog,
									unsigned int nSize )
{
	FILE* pFile = NULL;
	unsigned long i = 0;
