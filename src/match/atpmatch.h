...
int atMatchLists(int numA, s_star *listA, int numB, s_star *listB,
                 double radius, char *basename, int *num_matches,
                 	s_star *star_array_REM_J, int *num_stars_REM_J,
                 	s_star *star_array_REM_K, int *num_stars_REM_K );
...
/////////////////////////////////////////
// larry added this here from match.c at the top
...
int iter_trans(int nbright, s_star *star_array_A, int num_stars_A,
...
int calc_trans_coords(s_star *star, TRANS *trans,
