...
// Method:		AddCheck
// Class:		CSextractor
// Purpose:		Add a PSF to a CHECK-image (with a multiplicative factor).
//				Outside boundaries are taken into account.
// Input:		nothing
// Output:		nothing
////////////////////////////////////////////////////////////////////
void CSextractor::AddCheck( checkstruct *check, float *psf,
...
// Method:		BlankCheck
// Class:		CSextractor
// Purpose:		Blank a part of the CHECK-image according to a mask.
// Input:		nothing
// Output:		nothing
////////////////////////////////////////////////////////////////////
void CSextractor::BlankCheck( checkstruct *check, PIXTYPE *mask, int w,
...
// Method:		InitCheck
// Class:		CSextractor
// Purpose:		initialize check-image
// Input:		nothing
// Output:		nothing
////////////////////////////////////////////////////////////////////
checkstruct* CSextractor::InitCheck( char *filename, checkenum check_type, 
									int next )
{
   catstruct	*fitscat;
   checkstruct	*check;
...
// Method:		ReInitCheck
// Class:		CSextractor
// Purpose:		initialize check-image (for subsequent writing).
// Input:		nothing
// Output:		nothing
////////////////////////////////////////////////////////////////////
void CSextractor::ReInitCheck( picstruct *field, checkstruct *check )
{
   astromstruct	*as;
   char		*buf;
   int		i, ival;
...
// Output:		nothing
////////////////////////////////////////////////////////////////////
void CSextractor::WriteCheck( checkstruct *check, PIXTYPE *data, int w )
{
...
// Method:		ReEndCheck
// Class:		CSextractor
// Purpose:		Finish current check-image.
// Input:		nothing
// Output:		nothing
////////////////////////////////////////////////////////////////////
void CSextractor::ReEndCheck( picstruct *field, checkstruct *check )
{
   char		*buf;
   size_t	padsize;
...
// Method:		EndCheck
// Class:		CSextractor
// Purpose:		close check-image.
// Input:		nothing
// Output:		nothing
////////////////////////////////////////////////////////////////////
void CSextractor::EndCheck( checkstruct *check )
{
