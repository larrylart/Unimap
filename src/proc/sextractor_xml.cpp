...
// Method:		InitXml
// Class:		CSextractor
// Purpose:		Initialize a set of meta-data kept in memory before 
//				being written to the XML file
// Input:		Number of image extensions.
// Output:		RETURN_OK if everything went fine, RETURN_ERROR otherwise.
////////////////////////////////////////////////////////////////////
int CSextractor::InitXml( int next )
{
...
// Method:		UpdateXml
// Class:		CSextractor
// Purpose:		Update a set of meta-data kept in memory before being
//				written to the XML file
// Input:		nothing
// Output:		RETURN_OK if everything went fine, RETURN_ERROR otherwise.
////////////////////////////////////////////////////////////////////
int CSextractor::UpdateXml( sexcatstruct *sexcat, picstruct *dfield, 
...
// Output:		RETURN_OK if everything went fine, RETURN_ERROR otherwise.
////////////////////////////////////////////////////////////////////
int CSextractor::WriteXml( char *filename )
{
   FILE		*file;
...
// Output:		RETURN_OK if everything went fine, RETURN_ERROR otherwise.
////////////////////////////////////////////////////////////////////
int CSextractor::WriteXmlHeader( FILE *file )
{
...
// Input:		Pointer to the output file (or stream), Pointer to 
//				an error msg (or NULL).
// Output:		RETURN_OK if everything went fine, RETURN_ERROR otherwise.
////////////////////////////////////////////////////////////////////
int CSextractor::WriteXmlMeta( FILE *file, char *error )
{
...
/* Configuration file */
  ...
  if (!error)
	...
	" ucd=\"meta\" value=\"%s\"/>\n",
    	key[FindKeysOrig("CATALOG_TYPE",keylist,
	...
	" ucd=\"meta.code;instr.det;obs.param\" value=\"%s\"/>\n",
    	key[FindKeysOrig("DETECT_TYPE", keylist,
	...
	" ucd=\"meta.code;instr.sensitivity;obs.param\" value=\"%s",
    	key[FindKeysOrig("THRESH_TYPE", keylist,
			FIND_STRICT)].keylist[prefs.thresh_type[0]]);
    if (prefs.nthresh_type>1)
      fprintf(file, ",%s", key[FindKeysOrig("THRESH_TYPE", keylist,
	...
	" ucd=\"meta.code\" value=\"%s",
    	key[FindKeysOrig("FLAG_TYPE", keylist,
			FIND_STRICT)].keylist[prefs.flag_type[0]]);
      for (n=1; n<prefs.nimaflag; n++)
        fprintf(file, ",%s", key[FindKeysOrig("FLAG_TYPE", keylist,
	...
	" ucd=\"meta.code;obs.param;\" value=\"%s\"/>\n",
    	key[FindKeysOrig("BACKPHOTO_TYPE", keylist,
	...
	" ucd=\"meta.code\" value=\"%s",
    	key[FindKeysOrig("CHECKIMAGE_TYPE", keylist,
	...
	" ucd=\"meta.code;obs.param\" value=\"%s\"/>\n",
    	key[FindKeysOrig("PSFDISPLAY_TYPE", keylist,
...
////////////////////////////////////////////////////////////////////
// Method:		WriteXmlError
// Class:		CSextractor
// Purpose:		Save meta-data to a simplified XML file in case of a
//				catched error
// Input:		a character string.
// Output:		RETURN_OK if everything went fine, RETURN_ERROR otherwise.
////////////////////////////////////////////////////////////////////
void CSextractor::WriteXmlError( char *filename, char *error )
{
   FILE			*file;
