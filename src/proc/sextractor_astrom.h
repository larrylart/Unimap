...
#ifndef _SEXTRACTOR_ASTROM_H
#define _SEXTRACTOR_ASTROM_H
...
typedef enum {RDSYS_ICRS, RDSYS_FK5, RDSYS_FK4, RDSYS_FK4_NO_E, RDSYS_GAPPT} RefFrameType;
...
//  enum {RDSYS_ICRS, RDSYS_FK5, RDSYS_FK4, RDSYS_FK4_NO_E, RDSYS_GAPPT}
	RefFrameType	radecsys;		/* FITS RADECSYS reference frame */
