...
#ifndef _SEXTRACTOR_FITSCAT_H_
#define _SEXTRACTOR_FITSCAT_H_
...
// larry comment out this -is in sextractor main header for now
...
extern void	add_cleanupfilename(char *filename),
		...
		extern void swapbytes(void *, int , int );
