...
#ifndef _SEXTRACTOR_TYPES_H
#define _SEXTRACTOR_TYPES_H
...
/*----------------------------- image parameters ----------------------------*/
typedef enum {ICOMPRESS_NONE, ICOMPRESS_BASEBYTE, ICOMPRESS_PREVPIX} FitsCompressType;
typedef struct pic
  {
...
//  enum {ICOMPRESS_NONE, ICOMPRESS_BASEBYTE, ICOMPRESS_PREVPIX}
	FitsCompressType compress_type;		/* image compression type */
...
/* ---- image interpolation */
  ...
  ////////////////////////////////////////////////////
  // added by larry to keep pointer to opencv raw data buffer
  char* opencvbuff;
  double* vectImageBuff;
  ////////////////////////////////////////////////////
  }	picstruct;
