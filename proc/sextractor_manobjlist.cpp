////////////////////////////////////////////////////////////////////
// File:		sextractor_manobjlist.cpp
// Package:		SExtractor
// Author:		E.BERTIN (IAP)
...
// Method:		Belong
// Class:		CSextractor
// Purpose:		say if an object is "included" in another.
// Input:		nothing
// Output:		nothing
////////////////////////////////////////////////////////////////////
int CSextractor::Belong( int corenb, objliststruct *coreobjlist,
							int shellnb, objliststruct *shellobjlist )
{
	...
	for (pixt = spl+sobj->firstpix; pixt>=spl; pixt = spl+PLIST(pixt,nextpix))
		if ((PLIST(pixt,x) == xc) && (PLIST(pixt,y) == yc)) return 1;
...
// Method:		AddObj
// Class:		CSextractor
// Purpose:		Add an object to an objlist.
// Input:		nothing
// Output:		nothing
////////////////////////////////////////////////////////////////////
int CSextractor::AddObj( int objnb, objliststruct *objl1, objliststruct *objl2 )
{
	objstruct	*objl2obj;
	...
	if (objl2->nobj)
	{
		if (!(objl2obj = (objstruct *)realloc(objl2->obj, (++objl2->nobj) * sizeof(objstruct))))
			goto exit_addobj;
	...
	if (fp)
	{
		if (!(plist2 = (pliststruct *)realloc(plist2, (objl2->npix+=npx) * plistsize)))
			goto exit_addobj;
