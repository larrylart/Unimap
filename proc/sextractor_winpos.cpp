...
////////////////////////////////////////////////////////////////////
// Method:		ComputeWinpos
// Class:		CSextractor
// Purpose:		Compute windowed source barycenter. obj->posx and 
//				obj->posy are taken as initial centroid guesses.
// Input:		Picture structure pointer, Weight-map structure pointer,
//				object structure.
// Output:		nothing
////////////////////////////////////////////////////////////////////
void CSextractor::ComputeWinpos( picstruct *field, picstruct *wfield, 
														objstruct *obj )
{
   float		r2=0.0, raper=0.0,raper2=0.0, rintlim=0.0,rintlim2=0.0,rextlim2=0.0,
			dx=0.0,dx1=0.0,dy=0.0,dy2=0.0, sig=0.0, pdbkg=0.0,
                        offsetx=0.0,offsety=0.0,scalex=0.0,scaley=0.0,scale2=0.0, ngamma=0.0, locarea=0.0;
   double               tv=0.0, tv2=0.0, pix=0.0, var=0.0, backnoise2=0.0, gain=0.0, locpix=0.0,
			dxpos=0.0,dypos=0.0, twosig2=0.0, err=0.0,err2=0.0, emx2=0.0,emy2=0.0,emxy=0.0,
			esum=0.0, temp=0.0,temp2=0.0, mx2=0.0, my2=0.0,mxy=0.0,pmx2=0.0, theta=0.0, mx=0.0,my=0.0,
			mx2ph=0.0, my2ph=0.0;
   int                  i=0,x=0,y=0, x2=0,y2=0, xmin=0,xmax=0,ymin=0,ymax=0, sx=0,sy=0, w=0,h=0,
                        fymin=0,fymax=0, pflag=0,corrflag=0, gainflag=0, errflag=0,
			momentflag=0;
   long                 pos=0;
