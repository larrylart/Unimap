...
// Method:		InitAstrom
// Class:		CSextractor
// Purpose:		Initialize astrometrical structures.
// Input:		nothing
// Output:		nothing
////////////////////////////////////////////////////////////////////
void CSextractor::InitAstrom( picstruct *field )
{
   astromstruct	*as;
   double	*lm;
...
/* prjprm structure */
	...
	// larry :: removed this ... check proj.h with 
...
/*-- Compute an "average linear matrix" (at field center) */
    ComputeWcs(field, (field->width+1)/2.0, (field->height+1)/2.0);
...
////////////////////////////////////////////////////////////////////
// Method:		ComputeAstrom
// Class:		CSextractor
// Purpose:		Compute real WORLD coordinates and dimensions 
//				according to FITS info.
// Input:		nothing
// Output:		nothing
////////////////////////////////////////////////////////////////////
void CSextractor::ComputeAstrom( picstruct *field, objstruct *obj )
{
	astromstruct	*as;
	double	*lm, *wcspos;
...
/* If working with WCS, compute WORLD coordinates and local matrix */
  if (FLAG(obj2.mxw))
    ...
    if (as->wcs_flag)
      {
      wcspos = ComputeWcs(field, obj2->posx, obj2->posy);
...
/* Idem for peak-flux positions */
  if (FLAG(obj2.peakxw))
    ...
    if (as->wcs_flag)
      {
      wcspos = ComputeWcs(field, (double)obj->peakx, (double)obj->peaky);
...
/* Idem for Windowed positions */
  if (FLAG(obj2.winpos_xw))
    ...
    if (as->wcs_flag)
      {
      wcspos = ComputeWcs(field, obj2->winpos_x, obj2->winpos_y);
...
// Method:		ComputeWcs
// Class:		CSextractor
// Purpose:		Compute real WORLD coordinates and local distortion
//				matrix according to the WCS info.
// Input:		nothing
// Output:		nothing
////////////////////////////////////////////////////////////////////
double* CSextractor::ComputeWcs( picstruct *field, double mx, double my )
{
   astromstruct	*as;
  ...
  if ((rcode=l_wcsrev((const char(*)[9])as->ctype, as->wcs, pixpos, as->lin,
...
////////////////////////////////////////////////////////////////////
// Method:		AstromShapeparam
// Class:		CSextractor
// Purpose:		Compute shape parameters in WORLD and SKY coordinates.
// Input:		nothing
// Output:		nothing
////////////////////////////////////////////////////////////////////
void CSextractor::AstromShapeparam( picstruct *field, objstruct *obj )
{
   astromstruct	*as;
   double	*lm,
...
////////////////////////////////////////////////////////////////////
// Method:		AstromWinShapeparam
// Class:		CSextractor
// Purpose:		Compute shape parameters in WORLD and SKY coordinates.
// Input:		nothing
// Output:		nothing
////////////////////////////////////////////////////////////////////
void CSextractor::AstromWinShapeparam( picstruct *field, objstruct *obj )
{
   astromstruct	*as;
   double	*lm,
		dx2,dy2,dxy, xm2,ym2,xym, temp,pm2, lm0,lm1,lm2,lm3;
...
////////////////////////////////////////////////////////////////////
// Method:		AstromErrParam
// Class:		CSextractor
// Purpose:		Compute error ellipse parameters in WORLD and SKY 
//				coordinates.
// Input:		nothing
// Output:		nothing
////////////////////////////////////////////////////////////////////
void CSextractor::AstromErrParam( picstruct *field, objstruct *obj )
{
   astromstruct	*as;
   double	*lm,
		dx2,dy2,dxy, xm2,ym2,xym, temp,pm2, lm0,lm1,lm2,lm3;
...
// Output:		nothing
////////////////////////////////////////////////////////////////////
void CSextractor::AstromWinErrParam( picstruct *field, objstruct *obj )
{
   astromstruct	*as;
   double	*lm,
		dx2,dy2,dxy, xm2,ym2,xym, temp,pm2, lm0,lm1,lm2,lm3;
...
// Method:		CopyAstrom
// Class:		CSextractor
// Purpose:		Copy astrometrical structures.
// Input:		nothing
// Output:		nothing
////////////////////////////////////////////////////////////////////
void CSextractor::CopyAstrom( picstruct *infield, picstruct *outfield )
{
...
// Method:		EndAstrom
// Class:		CSextractor
// Purpose:		Free astrometrical structures.
// Input:		nothing
// Output:		nothing
////////////////////////////////////////////////////////////////////
void CSextractor::EndAstrom( picstruct *field )
{
   astromstruct	*as;
...
// Method:		Precess
// Class:		CSextractor
// Purpose:		precess equatorial coordinates according to the equinox 
//				(from Ephemerides du Bureau des Longitudes 1992). 
//				Epoch for coordinates should be J2000 (FK5 system).
// Input:		nothing
// Output:		nothing
////////////////////////////////////////////////////////////////////
void CSextractor::Precess( double yearin, double alphain, double deltain,
...
// Method:		J2B
// Class:		CSextractor
// Purpose:		conver equatorial coordinates from equinox and epoch 
//				J2000 to equinox and epoch B1950 for extragalactic 
//				sources (from Aoki et al. 1983, after inversion of 
//				their matrix and some custom arrangements).
// Input:		nothing
// Output:		nothing
////////////////////////////////////////////////////////////////////
void CSextractor::J2B( double yearobs, double alphain, double deltain,
