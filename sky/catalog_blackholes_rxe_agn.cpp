...
// Output:	nothing
/////////////////////////////////////////////////////////////////////
CSkyCatalogBlackholesRxeagn::CSkyCatalogBlackholesRxeagn( CSkyCatalogBlackholes* pCatalogBlackholes, CUnimapWorker* pWorker ) 
{
...
// Output:	nothing
/////////////////////////////////////////////////////////////////////
CSkyCatalogBlackholesRxeagn::~CSkyCatalogBlackholesRxeagn()
{
...
/////////////////////////////////////////////////////////////////////
unsigned long CSkyCatalogBlackholesRxeagn::Load( int nLoadType, int nLoadSource, int nLoadLimit, 
									  int bRegion, double nCenterRa, double nCenterDec, double nRadius )
{
	// check catalog loaded
	if( m_pCatalogBlackholes->m_vectData != NULL )
	{
		if( m_pCatalogBlackholes->m_nCatalogLoaded != CATALOG_ID_RXE_AGN )
	...
	} else if( nLoadType == CATALOG_LOAD_REMOTE )
	{
		if( nLoadSource == CATALOG_QUERY_SOURCE_VIZIER )
		{
			...
			nObj = oRemote.GetBlackholesFromVizier( CATALOG_ID_RXE_AGN, bRegion, nCenterRa, nCenterDec, nRadius, nRadius );
		}
	}
...
// Output:	nothing
/////////////////////////////////////////////////////////////////////
unsigned long CSkyCatalogBlackholesRxeagn::LoadBinary( const wxString& strFile, double nCenterRa, double nCenterDec, 
										double nRadius, int bRegion )
{
	...
	while( !feof( pFile ) )
	{
		...
		// :: name - 19 chars - tocheck: here it was to read 20 ... check if should be 19 or 20!!!
		...
		if( !fread( (void*) &(m_pCatalogBlackholes->m_vectData[m_pCatalogBlackholes->m_nData].dec), sizeof(double), 1, pFile ) )
			break;
		// :: blackholes properties
		if( !fread( (void*) &(m_pCatalogBlackholes->m_vectData[m_pCatalogBlackholes->m_nData].mass), sizeof(double), 1, pFile ) )
			break;
		if( !fread( (void*) &(m_pCatalogBlackholes->m_vectData[m_pCatalogBlackholes->m_nData].xray_luminosity), sizeof(double), 1, pFile ) )
			break;
		if( !fread( (void*) &(m_pCatalogBlackholes->m_vectData[m_pCatalogBlackholes->m_nData].radio_luminosity), sizeof(double), 1, pFile ) )
			break;
...
// Output:	status
/////////////////////////////////////////////////////////////////////
int CSkyCatalogBlackholesRxeagn::ExportBinary( DefCatBlackhole* vectCatalog,
									unsigned int nSize )
{
	FILE* pFile = NULL;
	unsigned long i = 0;
