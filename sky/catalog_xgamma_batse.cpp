...
/////////////////////////////////////////////////////////////////////
// Method:	Constructor
// Class:	CSkyCatalogXGammaBatse
// Purpose:	intialize my object
// Input:	nothing
// Output:	nothing
/////////////////////////////////////////////////////////////////////
CSkyCatalogXGammaBatse::CSkyCatalogXGammaBatse( CSkyCatalogXGamma* pCatalogXGamma, CUnimapWorker* pWorker ) 
{
...
// Output:	nothing
/////////////////////////////////////////////////////////////////////
CSkyCatalogXGammaBatse::~CSkyCatalogXGammaBatse()
{
									  ...
									  int bRegion, double nCenterRa, double nCenterDec, double nRadius )
{
	...
	} else if( nLoadType == CATALOG_LOAD_REMOTE )
	{
		if( nLoadSource == CATALOG_QUERY_SOURCE_VIZIER )
		{
			...
			nObj = oRemote.GetXGammaFromVizier( CATALOG_ID_BATSE, bRegion, nCenterRa, nCenterDec, nRadius, nRadius );
		}
	}
...
// Method:	LoadBinary
// Class:	CSkyCatalogXGammaBatse
// Purpose:	load the binary version of the BATSE radio sources catalog
// Input:	if to load region or all
// Output:	nothing
/////////////////////////////////////////////////////////////////////
unsigned long CSkyCatalogXGammaBatse::LoadBinary( const wxString& strFile, double nCenterRa, double nCenterDec, 
										double nRadius, int bRegion )
{
	...
	while( !feof( pFile ) )
	{
		...
		// :: name - 22 chars
		if( !fread( (void*) &(m_pCatalogXGamma->m_vectData[m_pCatalogXGamma->m_nData].cat_name), sizeof(char), 7, pFile ) )
			break;
		// :: catalog number 
...
// Method:	ExportBinary
// Class:	CSkyCatalogXGammaBatse
// Purpose:	export BATSE radio catalog as binary
// Input:	reference vector,size, and file to export to
// Output:	status
/////////////////////////////////////////////////////////////////////
int CSkyCatalogXGammaBatse::ExportBinary( DefCatBasicXGamma* vectCatalog,
									unsigned int nSize )
{
	FILE* pFile = NULL;
	unsigned long i = 0;
	...
	{
		// :: name - 22 chars
		if( !fwrite( (void*) &(vectCatalog[i].cat_name), sizeof(char), 7, pFile ) )
			break;
		// :: catalog number
