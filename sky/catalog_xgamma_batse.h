...
#ifndef _CATALOG_XGAMMA_BATSE_H
#define _CATALOG_XGAMMA_BATSE_H
...
// methods:
public:
	CSkyCatalogXGammaBatse( CSkyCatalogXGamma* pCatalogXGamma, CUnimapWorker* pWorker=NULL );
	~CSkyCatalogXGammaBatse( );
