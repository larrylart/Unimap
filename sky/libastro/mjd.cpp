// functions to manipulate the modified-julian-date used throughout the program 
...
////////////////////////////////////////////////////////////////////
// Method:	cal_mjd
// Purpose:	given a date in months, mn, days, dy, years, yr, return
//			the modified Julian date (number of days elapsed since 
//			1900 jan 0.5), *mjd.
////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////
// Purpose:	given the modified Julian date (number of days elapsed 
//			since 1900 jan 0.5,), mj, return the calendar date in 
//			months, *mn, days, *dy, and years, *yr.
////////////////////////////////////////////////////////////////////
void mjd_cal( double mj, int *mn, double *dy, int *yr )
{
...
////////////////////////////////////////////////////////////////////
// Purpose:	given an mjd, set *dow to 0..6 according to which day of 
//			the week it falls on (0=sunday). return 0 if ok else -1 
//			if can't figure it out.
////////////////////////////////////////////////////////////////////
int mjd_dow( double mj, int *dow )
{
	...
	// 1/1/1900 (mj 0.5) is a Monday
	*dow = ((long)floor(mj-.5) + 1) % 7;
	if (*dow < 0)
	    *dow += 7;
...
void mjd_dpm( double mj, int *ndays )
{
...
void mjd_dayno( double mj, int *yr, double *dy )
{
	double yrd;
	int yri;
	int dpy;
...
void mjd_year( double mj, double *yr )
{
...
void year_mjd( double y, double *mjp )
{
	double e0, e1;	/* mjd of start of this year, start of next year */
	int yf = (int)floor (y);
	if (yf == -1) yf = -2;
...
// insure 0 <= ra < 2PI and -PI/2 <= dec <= PI/2. if dec needs complimenting, reflect ra too
