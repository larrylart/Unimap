...
static void meeus_jupiter( double d, double *cmlI, double *cmlII, MoonData md[J_NMOONS] );
...
// RA of Jupiter's north pole 
#define POLE_RA   degrad(268.05)	 
// Dec of Jupiter's north pole 
#define POLE_DEC  degrad(64.50)		
