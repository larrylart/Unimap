...
{
    double A1=0.0, A10=0.0, A2=0.0, A3=0.0, A4=0.0, A5=0.0, A6=0.0, A7=0.0, A8=0.0, A9,
		AINV2=0.0, AQNV=0.0, BFACT=0.0,
	C=0.0, CC=0.0, COSQ=0.0, CTEM, DAY=0.0, DS50=0.0, EOC=0.0, EQ=0.0, F220=0.0, F221=0.0, F311=0.0, F321=0.0, F322=0.0,
	F330, F441, F442, F522, F523, F542, F543, G200, G201, G211, G300,
	G310, G322, G410, G422, G520, G521, G532, G533, GAM, PREEP, S1=0.0, S2=0.0,
	S3=0.0, S4=0.0, S5=0.0, S6=0.0, S7=0.0, SE=0.0, SGH=0.0, SH=0.0, SI=0.0, SINI2=0.0, SINQ=0.0, SL=0.0, STEM=0.0, TEMP=0.0,
